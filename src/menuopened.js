...
//const closeMenuBtn = document.querySelector(".close-menu"); // seleccionamos el elemento que tiene clase close-menu.


//function toggleMenu() {
  //menu.classList.toggle("menu_opened"); // función para alternar el menu, si esta abierto lo cierre y viceversa.}
